...
export const SettingsIcon = (p: P) => (
  <svg {...base(p)}>
    ...
    <path d="M19.4 13a7.6 7.6 0 0 0 0-2l1.7-1.3-1.6-2.8-2 .8a7.6 7.6 0 0 0-1.7-1l-.3-2.1H10.5l-.3 2.1a7.6 7.6 0 0 0-1.7 1l-2-.8L4.9 9.7 6.6 11a7.6 7.6 0 0 0 0 2l-1.7 1.3 1.6 2.8 2-.8a7.6 7.6 0 0 0 1.7 1l.3 2.1h3.2l.3-2.1a7.6 7.6 0 0 0 1.7-1l2 .8 1.6-2.8z" />
  </svg>
)
